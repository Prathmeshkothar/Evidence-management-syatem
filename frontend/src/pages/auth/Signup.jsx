  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.role === 'admin') {
        endpoint = 'http://localhost:5000/api/auth/signup/admin';
      } else if (formData.role === 'investigation' || formData.role === 'forensic') {
        endpoint = 'http://localhost:5000/api/auth/signup/officer';
      }
      ...
      if (response.data.token) {
        ...
        const message = formData.role === 'admin'
